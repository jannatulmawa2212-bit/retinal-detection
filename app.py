...
* { font-family: 'Nunito', sans-serif !important; }
    ...
    section[data-testid="stSidebar"] {
        background: linear-gradient(180deg, #1a0d2e 0%, #161B22 100%);
    ...
    @keyframes heroGlow {
        0%,100% { box-shadow: 0 8px 32px rgba(156,39,176,0.2); }
        50%      { box-shadow: 0 8px 40px rgba(233,30,140,0.4); }
    }
    .hero-header { animation: heroGlow 3s ease infinite; }
    .metric-card { animation: fadeInUp 0.5s ease; }
    .disease-card { animation: fadeInUp 0.4s ease; }
    .status-detected { animation: fadeInUp 0.3s ease; }
    .status-normal   { animation: fadeInUp 0.3s ease; }
